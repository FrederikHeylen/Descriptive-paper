...
#q73 members origin region (1 = Flanders, 2 = Wallonia, 3 = Federal)
{
  ...
  data$q73r <- ifelse(data$q73b_04r==1&data$q73b_01r!=1&data$q73b_02r!=1,2,
                       ifelse((data$q73b_01r==1|data$q73b_02r==1)&(data$q73b_04r!=1&data$q73b_06r!=1),3,
                              ifelse((data$q73b_06r==1|(data$q73b_04r==1&data$q73b_01r==1))|(data$q73b_04r==1&data$q73b_02r==1),1,
                                     NA)))
}
